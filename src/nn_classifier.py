...
class NN():
	...
	def get_validation_error(self):
		...
		'''
		Compute validation accuracy. Please only compute the error on the sample_size number
	...
	def get_train_error(self):
		...
		'''
		Compute train accuracy. Please only compute the error on the sample_size number
		over randomly selected data points. To save computation.
		'''
